...
```web3j solidity generate -b ./java-output/__contracts_IoTDataMarketplace_sol_DataStreamEntity.bin -a ./java-output/__contracts_IoTDataMarketplace_sol_DataStreamEntity.abi -o ./java-output/ -p com.iotdatamp.mpbcclient```